...
export const validatePin = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (!isValid) {
      console.log(`Failed PIN attempt from IP: ${clientIp}, PIN: ${pin}`);
    ...
    console.log('Setting PIN session cookie with options:', cookieOptions);
    ...
    console.log(`Successful PIN access from IP: ${clientIp}`);
    console.log('Cookie should be set with sessionId:', sessionId);
...
export const generateNewPin = async (req: Request, res: Response) => {
  try {
    ...
    console.log('New access PIN generated by admin');
