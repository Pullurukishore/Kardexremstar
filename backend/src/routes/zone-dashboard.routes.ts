...
router.get(
  '/zone-info',
  requireRole(['ZONE_MANAGER', 'ZONE_USER', 'ADMIN', 'SERVICE_PERSON']),
  getZoneInfo
);
...
router.get(
  '/',
  requireRole(['ZONE_MANAGER', 'ZONE_USER', 'ADMIN', 'SERVICE_PERSON']), // Allow zone managers, zone users, admins, and service persons
