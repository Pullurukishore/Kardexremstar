          ...
          <Card className="shadow-sm border-border/50 hover:shadow-md transition-shadow duration-200">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {(ticket.status === 'ONSITE_VISIT_REACHED' || ticket.status === 'ONSITE_VISIT_IN_PROGRESS' || ticket.status === 'ONSITE_VISIT_RESOLVED') && (
                        <Button 
                          variant="outline" 
                          size="sm" 
                          className="h-8 px-3 bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 border-green-200 hover:border-green-300 text-green-700 hover:text-green-800 transition-all duration-200 shadow-sm hover:shadow-md" 
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                {ticket.callType && (
                  <div>
                    <h3 className="font-medium mb-2">Call Type</h3>
                    <Badge variant={ticket.callType === 'UNDER_MAINTENANCE_CONTRACT' ? 'default' : 'secondary'}>
