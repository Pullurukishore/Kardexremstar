...
// apiClient is already imported from '@/lib/api/client'
...
export default function EditOfferPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If stage changed, update the stage using the offers endpoint
      if (stageChanged) {
      ...
      await apiClient.put(`/offers/${offerId}`, updateData)
